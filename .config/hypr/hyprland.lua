...
hl.on("hyprland.start", function ()
   ...
   hl.exec_cmd("waybar & hyprpaper -c /home/dev/.config/hypr/hyprpaper.conf & firefox")
end)
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(079c8dee)", "rgba(057065ee)"}, angle = 45 },
            inactive_border = "rgba(162b27aa)",
        },
...
hl.bind(mainMod .. " + SHIFT + period", hl.dsp.focus({ monitor = "right" }))
hl.bind(mainMod .. " + SHIFT + comma", hl.dsp.focus({ monitor = "left" }))
...
hl.bind(mainMod .. " + CTRL + P", hl.dsp.exec_cmd("grim -g \"$(slurp)\" ~/Screenshots/$(date +'%Y-%m-%d_%H-%M-%S').png"))
